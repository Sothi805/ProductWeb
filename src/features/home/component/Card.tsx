...
const Card = () => {
  ...
  return (
    <div className="max-w-xs rounded-lg overflow-hidden cursor-pointer shadow-md border border-gray-200 bg-white hover:-translate-y-1 hover:shadow-[#7EACB5] transition-all duration-300">
      {/* Image Section */}
      <img
